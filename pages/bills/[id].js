      ...
      <div style={{ maxWidth: 520, margin: '0 auto', minHeight: '100vh', background: '#f0f2f5', paddingBottom: 24 }}>
        ...
        <div style={{ padding: '12px 12px 0' }}>
          <button onClick={sendWhatsApp} disabled={waSending}
            style={{ width: '100%', padding: '13px', background: waSending ? '#aaa' : '#25D366', color: '#fff', border: 'none', borderRadius: 12, fontSize: 15, fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
            {waSending ? 'Preparing...' : (
              <>
